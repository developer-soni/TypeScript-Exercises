...
We will be working with a **file system**. A file system organizes
...
and/or files. Your task on this extra will be to implement a toy model of some of the
usual functionality associated with a file system such as creating and deleting files.

The toy model we will use for this extra is the algebraic data-type given below.
** ============================================================================ */
...
export function replaceEntry(fstr: FileSystemTree[], newEntry: FileSystemTree): FileSystemTree[] {
  ...
  function replaceEntryInner(fstr: FileSystemTree[], newEntry: FileSystemTree) {
...
export function findFilesOrDirs(fstr: FileSystemTree, predicate: (name: string) => boolean): string[][] {
  ...
  function findFilesOrDirsInner(fstr: FileSystemTree, predicate: (name: string) => boolean): void {
    if (fstr.tag === 'FILE') {
